...
export const LICO_DATA: LicoEntry[] = [
  { size: { FR: "1 personne", EN: "1 person" }, income: 30526 },
  { size: { FR: "2 personnes", EN: "2 persons" }, income: 38002 },
  { size: { FR: "3 personnes", EN: "3 persons" }, income: 46720 },
  { size: { FR: "4 personnes", EN: "4 persons" }, income: 56724 },
  { size: { FR: "5 personnes", EN: "5 persons" }, income: 64336 },
  { size: { FR: "6 personnes", EN: "6 persons" }, income: 72560 },
  { size: { FR: "7+ personnes", EN: "7+ persons" }, income: 80784 }
];
...
export const TRANSLATIONS = {
  FR: {
    ...
    eligibility: {
      ...
      formDependents: "Personnes à charge au Canada",
      formDependentsPlaceholder: "Ex: 2 (conjoint, enfants...)",
      formIncome: "Revenu annuel brut (CAD)",
      formIncomePlaceholder: "Ex: 55000",
      formSubmit: "Vérifier maintenant",
      formWarning: "Ce calculateur fournit une estimation basée sur les barèmes LICO 2026. Seul un agent de l'IRCC peut confirmer l'éligibilité finale.",
      ...
      resultIncomeNote: (income: string, required: string, size: number) => `Votre revenu de ${income}$ CAD dépasse le minimum requis de ${required}$ CAD pour une famille de ${size} personnes.`,
      resultGapNote: (gap: string) => `Il vous manque environ ${gap}$ CAD pour atteindre le seuil LICO. Un co-signataire pourrait vous aider.`,
  ...
  EN: {
    ...
    eligibility: {
      ...
      formDependents: "Dependents in Canada",
      formDependentsPlaceholder: "Ex: 2 (spouse, children...)",
      formIncome: "Gross Annual Income (CAD)",
      formIncomePlaceholder: "Ex: 55000",
      formSubmit: "Check now",
      formWarning: "This calculator provides an estimate based on 2026 LICO scales. Only an IRCC officer can confirm final eligibility.",
      ...
      resultIncomeNote: (income: string, required: string, size: number) => `Your income of $${income} CAD exceeds the minimum required of $${required} CAD for a family of ${size} people.`,
      resultGapNote: (gap: string) => `You are short by approximately $${gap} CAD to reach the LICO threshold. A co-signer could help you.`,
